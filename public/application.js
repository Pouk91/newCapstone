...
/***/ (function(module, exports, __webpack_require__) {
	...
	var repairEvents = __webpack_require__(13

	// On document ready
	);$(function () {
	  authEvents.addHandlers();
	  repairEvents.addHandlers();
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.signIn(data).then(ui.signInSuccess).then(repairEvents.onGetRepairs).catch(ui.signInFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateRepairs = __webpack_require__(36);

	var onCreateRepair = function onCreateRepair(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createRepair(data).then(ui.createRepairSuccess).then(onGetRepairs).catch(ui.createRepairFailure);
	};

	var onGetRepairs = function onGetRepairs(event) {
	  if (event) {
	    event.preventDefault();
	  }
	  api.getRepairs().then(ui.getRepairsSuccess).catch(ui.getRepairsFailure);
	};

	var onUpdateRepair = function onUpdateRepair(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  var id = data.repair.id;
	  api.updateRepair(id, data).then(ui.updateRepairSuccess).then(onGetRepairs).catch(ui.updateRepairFailure);
	};

	var toUpdateRepair = function toUpdateRepair(event) {
	  event.preventDefault();
	  $('#content').empty();
	...
	var onDeleteRepair = function onDeleteRepair(event) {
	  event.preventDefault();
	  var repairId = $(event.target).attr('repairId');
	  api.deleteRepair(repairId).then(ui.deleteRepairSuccess).then(onGetRepairs).catch(ui.deleteRepairFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getRepairs = function getRepairs() {
	  return $.ajax({
	    url: config.apiOrigin + '/repairs',
	    method: 'GET',
	    headers: {
	...
	var updateRepair = function updateRepair(id, data) {
	  return $.ajax({
	...
	var deleteRepair = function deleteRepair(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/repairs/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var showRepairsTemplate = __webpack_require__(16);
	...
	var createRepairSuccess = function createRepairSuccess(data) {
	...
	var createRepairFailure = function createRepairFailure(data) {
	...
	var getRepairsSuccess = function getRepairsSuccess(data) {
	  $('#content').empty();
	  var showRepairsHTML = showRepairsTemplate({ repairs: data.repairs });
	  $('#content').append(showRepairsHTML);
	  resetFormField();
	};

	var getRepairsFailure = function getRepairsFailure(data) {
	  resetFormField();
	};

	var updateRepairSuccess = function updateRepairSuccess(data) {
	...
	var updateRepairFailure = function updateRepairFailure(data) {
	...
	var deleteRepairSuccess = function deleteRepairSuccess(id) {
	...
	var deleteRepairFailure = function deleteRepairFailure(data) {
	...
	module.exports = {
	  createRepairSuccess: createRepairSuccess,
	  createRepairFailure: createRepairFailure,
	  getRepairsSuccess: getRepairsSuccess,
	  getRepairsFailure: getRepairsFailure,
	  updateRepairSuccess: updateRepairSuccess,
	  updateRepairFailure: updateRepairFailure,
	  deleteRepairSuccess: deleteRepairSuccess,
	  deleteRepairFailure: deleteRepairFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<tr>\n  <td class='repairs-list' data-id=\""
	    ...
	    + "</td>\n    <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.repairname : stack1), depth0))
	    + "</td>\n    <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.repaircost : stack1), depth0))
	    + "</td </td>\n    <td><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"click\" class=\"btn btn-primary update-repair-button\">Update</button></td>\n    <td><button repairId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"click\" class=\"btn btn-danger delete-repair-button\">Delete</button></td>\n  </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<html>\n<table id=\"user-repair-list\" class=\"table table-striped signed-in-view\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.repairs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</table>\n</html>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "    <form id=\"update-repair\">\n      <input type=\"text\" name=\"repair[id]\" placeholder=\"Enter Repair Id\" class=\"repairId\">\n      <input type=\"text\" name=\"repair[year]\" placeholder=\"Car Year\">\n      <input type=\"text\" name=\"repair[make]\" placeholder=\"Car Make\">\n      <input type=\"text\" name=\"repair[model]\" placeholder=\"Car Model\">\n      <input type=\"text\" name=\"repair[repairname]\" placeholder=\"Name of Repair?\">\n      <input type=\"text\" name=\"repair[repaircost]\" placeholder=\"Repair Cost?\">\n      <input class=\"btn btn-primary\" type=\"submit\" name=\"submit\" value=\"Update Repair\">\n    </form>\n";
	},"useData":true});
